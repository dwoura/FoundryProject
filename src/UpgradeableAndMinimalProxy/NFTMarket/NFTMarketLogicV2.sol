...
import "src/NFTMarket/ITokenReceiver.sol";
import "forge-std/console.sol";
import {IERC20Permit} from "@openzeppelin/contracts/token/ERC20/extensions/IERC20Permit.sol";

/// @custom:oz-upgrades-from NFTMarketLogicV1
contract NFTMarketLogicV2 is Initializable, EIP712Upgradeable{
    ...
    bytes32 public WHITELIST_TYPEHASH;
    ...
    function initialize() public reinitializer(2){
        ...
        WHITELIST_TYPEHASH = keccak256("WhiteList(address user,address nftAddr,uint256 buyLimit,uint256 deadline)");
    }
    ...
    function permitList(address nftAddr, uint nftId,address currency,uint price, uint8 v, bytes32 r, bytes32 s) public{
        ...
        if(signer != msg.sender){
            revert InvalidSignature(signer, msg.sender);
        }

        list(nftAddr, nftId, currency,price);
    }
